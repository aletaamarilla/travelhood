...
const LOCATION_COORDS: Record<string, [number, number]> = {
  ...
  "Ciudad Vieja": [50.0870, 14.4208],
  "Barrio Judío": [50.0906, 14.4183],
  "Castillo": [50.0911, 14.4016],
  "Moldava": [50.0875, 14.4213],
  "Mercados navideños": [50.0870, 14.4208],
  "Ciudad de Guatemala": [14.6349, -90.5069],
  "Guatemala": [14.5586, -90.7295],
  "Flores": [16.9297, -89.8914],
  "Lago Petén Itzá": [16.9297, -89.8914],
  "Yaxhá": [17.0667, -89.4000],
  "Tikal": [17.2220, -89.6237],
  "Antigua": [14.5586, -90.7295],
  "Acatenango": [14.5007, -90.8758],
  "Lago Atitlán": [14.6907, -91.2025],
  "San Juan La Laguna": [14.6942, -91.2861],
  "Panajachel": [14.7419, -91.1585],
  "El Paredón": [13.9219, -91.0781],
}
