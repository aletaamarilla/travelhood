...
export const continents: Continent[] = [
  ...
  },
  {
    ...
    seoDescription: "Viajes en grupo a Asia para jóvenes: Tailandia, Bali, Maldivas, Sri Lanka y Filipinas. Grupos reducidos de 12-18 personas con coordinador.",
  },
  {
    id: "africa",
    name: "África",
...
export const destinations: Destination[] = [
  {
    ...
    faqs: [
      ...
      { question: "¿Cuántas personas viajan en el grupo?", answer: "Los grupos suelen ser reducidos (12-15 personas) para asegurar una experiencia cercana, divertida y personalizada." },
...
export const trips: Trip[] = [
  ...
  { id: "egipto-2026-07-15", destinationId: "egipto", title: "Egipto — Julio 2026 (2)", departureDate: "2026-07-15", returnDate: "2026-07-22", durationDays: 8, priceFrom: 950, flightEstimate: 300, totalPlaces: 15, placesLeft: 15, coordinatorId: "marta", status: "open", included: [...defaultIncluded, "Vuelo interno El Cairo–Luxor o tren nocturno", "Guía local en español", "4x4 y quads en el desierto", "Snorkel en el Mar Rojo con almuerzo", "Paseo por el Nilo con cena y espectáculo"], notIncluded: [...defaultNotIncluded, "Visado", "Propinas", "Entradas a monumentos", "Vuelo en Globo (opcional)"], itinerary: [], tags: ["verano"] },
  ...
  { id: "egipto-2026-11-13", destinationId: "egipto", title: "Egipto — Noviembre 2026 (2)", departureDate: "2026-11-13", returnDate: "2026-11-20", durationDays: 8, priceFrom: 950, flightEstimate: 300, totalPlaces: 15, placesLeft: 15, coordinatorId: "marta", status: "open", included: [...defaultIncluded, "Vuelo interno El Cairo–Luxor o tren nocturno", "Guía local en español", "4x4 y quads en el desierto", "Snorkel en el Mar Rojo con almuerzo", "Paseo por el Nilo con cena y espectáculo"], notIncluded: [...defaultNotIncluded, "Visado", "Propinas", "Entradas a monumentos", "Vuelo en Globo (opcional)"], itinerary: [], tags: ["puente-noviembre"] },
  // Islandia
  { id: "islandia-2026-09-28", destinationId: "islandia", title: "Islandia — Sep-Oct 2026", departureDate: "2026-09-28", returnDate: "2026-10-05", durationDays: 8, priceFrom: 1250, flightEstimate: 280, totalPlaces: 15, placesLeft: 4, coordinatorId: "marta", status: "almost-full", included: [...defaultIncluded, "Chófer durante todo el recorrido", "Gasolina y parking", "Entradas a termas"], notIncluded: defaultNotIncluded, itinerary: [], tags: ["septiembre"] },
  { id: "islandia-2026-10-05", destinationId: "islandia", title: "Islandia — Octubre 2026", departureDate: "2026-10-05", returnDate: "2026-10-12", durationDays: 8, priceFrom: 1250, flightEstimate: 280, totalPlaces: 15, placesLeft: 5, coordinatorId: "carlos", status: "open", included: [...defaultIncluded, "Chófer durante todo el recorrido", "Gasolina y parking", "Entradas a termas"], notIncluded: defaultNotIncluded, itinerary: [], tags: ["puente-octubre"] },
  { id: "islandia-2026-10-12", destinationId: "islandia", title: "Islandia — Octubre 2026 (2)", departureDate: "2026-10-12", returnDate: "2026-10-19", durationDays: 8, priceFrom: 1250, flightEstimate: 280, totalPlaces: 15, placesLeft: 15, coordinatorId: "marta", status: "open", included: [...defaultIncluded, "Chófer durante todo el recorrido", "Gasolina y parking", "Entradas a termas"], notIncluded: defaultNotIncluded, itinerary: [], tags: ["puente-octubre"] },
  { id: "islandia-2026-10-19", destinationId: "islandia", title: "Islandia — Octubre 2026 (3)", departureDate: "2026-10-19", returnDate: "2026-10-26", durationDays: 8, priceFrom: 1250, flightEstimate: 280, totalPlaces: 15, placesLeft: 15, coordinatorId: "carlos", status: "open", included: [...defaultIncluded, "Chófer durante todo el recorrido", "Gasolina y parking", "Entradas a termas"], notIncluded: defaultNotIncluded, itinerary: [], tags: ["puente-octubre"] },
  // Zanzíbar
  { id: "zanzibar-2026-11-29", destinationId: "zanzibar", title: "Zanzíbar — Nov-Dic 2026", departureDate: "2026-11-29", returnDate: "2026-12-06", durationDays: 8, priceFrom: 1300, flightEstimate: 650, totalPlaces: 15, placesLeft: 5, coordinatorId: "marta", status: "open", included: [...defaultIncluded, "2 excursiones de snorkel con equipamiento y comida", "Visita a Mnemba y Prison Island", "Entrada a centro de conservación de tortugas", "Cena de bienvenida y despedida", "Guía local"], notIncluded: [...defaultNotIncluded, "Visado", "Safari en Mikumi (opcional)"], itinerary: [], tags: ["puente-noviembre"] },
  // Tailandia Verano
  { id: "tailandia-verano-2026-07-01", destinationId: "tailandia-verano", title: "Tailandia Verano — Julio 2026", departureDate: "2026-07-01", returnDate: "2026-07-14", durationDays: 14, priceFrom: 1300, flightEstimate: 650, totalPlaces: 15, placesLeft: 5, coordinatorId: "marta", status: "open", included: [...defaultIncluded, "Ferrys entre islas", "Vuelos internos", "Excursión a santuario de elefantes + trekking + rafting", "Entrada al Parque Nacional Ang Thong con almuerzo", "Visita a templos en Chiang Mai", "Cena BBQ en Koh Tao", "Excursión a Koh Nang Yuan"], notIncluded: [...defaultNotIncluded, "Transportes no principales (taxis, tuk tuks, Grab)", "Transporte a Ayutthaya", "Entradas a templos (Ayutthaya y Bangkok)"], itinerary: [], tags: ["verano"] },
  { id: "tailandia-verano-2026-07-16", destinationId: "tailandia-verano", title: "Tailandia Verano — Julio 2026 (2)", departureDate: "2026-07-16", returnDate: "2026-07-29", durationDays: 14, priceFrom: 1300, flightEstimate: 650, totalPlaces: 15, placesLeft: 3, coordinatorId: "carlos", status: "almost-full", included: [...defaultIncluded, "Ferrys entre islas", "Vuelos internos", "Excursión a santuario de elefantes + trekking + rafting", "Entrada al Parque Nacional Ang Thong con almuerzo", "Visita a templos en Chiang Mai", "Cena BBQ en Koh Tao", "Excursión a Koh Nang Yuan"], notIncluded: [...defaultNotIncluded, "Transportes no principales (taxis, tuk tuks, Grab)", "Transporte a Ayutthaya", "Entradas a templos (Ayutthaya y Bangkok)"], itinerary: [], tags: ["verano"] },
  { id: "tailandia-verano-2026-08-01", destinationId: "tailandia-verano", title: "Tailandia Verano — Agosto 2026", departureDate: "2026-08-01", returnDate: "2026-08-14", durationDays: 14, priceFrom: 1300, flightEstimate: 650, totalPlaces: 15, placesLeft: 4, coordinatorId: "marta", status: "almost-full", included: [...defaultIncluded, "Ferrys entre islas", "Vuelos internos", "Excursión a santuario de elefantes + trekking + rafting", "Entrada al Parque Nacional Ang Thong con almuerzo", "Visita a templos en Chiang Mai", "Cena BBQ en Koh Tao", "Excursión a Koh Nang Yuan"], notIncluded: [...defaultNotIncluded, "Transportes no principales (taxis, tuk tuks, Grab)", "Transporte a Ayutthaya", "Entradas a templos (Ayutthaya y Bangkok)"], itinerary: [], tags: ["verano"] },
  { id: "tailandia-verano-2026-08-16", destinationId: "tailandia-verano", title: "Tailandia Verano — Agosto 2026 (2)", departureDate: "2026-08-16", returnDate: "2026-08-29", durationDays: 14, priceFrom: 1300, flightEstimate: 650, totalPlaces: 15, placesLeft: 15, coordinatorId: "carlos", status: "open", included: [...defaultIncluded, "Ferrys entre islas", "Vuelos internos", "Excursión a santuario de elefantes + trekking + rafting", "Entrada al Parque Nacional Ang Thong con almuerzo", "Visita a templos en Chiang Mai", "Cena BBQ en Koh Tao", "Excursión a Koh Nang Yuan"], notIncluded: [...defaultNotIncluded, "Transportes no principales (taxis, tuk tuks, Grab)", "Transporte a Ayutthaya", "Entradas a templos (Ayutthaya y Bangkok)"], itinerary: [], tags: ["verano"] },
  { id: "tailandia-verano-2026-09-01", destinationId: "tailandia-verano", title: "Tailandia Verano — Septiembre 2026", departureDate: "2026-09-01", returnDate: "2026-09-14", durationDays: 14, priceFrom: 1300, flightEstimate: 650, totalPlaces: 15, placesLeft: 15, coordinatorId: "marta", status: "open", included: [...defaultIncluded, "Ferrys entre islas", "Vuelos internos", "Excursión a santuario de elefantes + trekking + rafting", "Entrada al Parque Nacional Ang Thong con almuerzo", "Visita a templos en Chiang Mai", "Cena BBQ en Koh Tao", "Excursión a Koh Nang Yuan"], notIncluded: [...defaultNotIncluded, "Transportes no principales (taxis, tuk tuks, Grab)", "Transporte a Ayutthaya", "Entradas a templos (Ayutthaya y Bangkok)"], itinerary: [], tags: ["septiembre"] },
  // Filipinas Verano
  { id: "filipinas-verano-2026-07-01", destinationId: "filipinas-verano", title: "Filipinas Verano — Julio 2026", departureDate: "2026-07-01", returnDate: "2026-07-13", durationDays: 13, priceFrom: 1350, flightEstimate: 750, totalPlaces: 15, placesLeft: 5, coordinatorId: "carlos", status: "open", included: [...defaultIncluded, "Vuelos internos y ferry", "Island Hopping tours con comida", "Tours de un día (Camiguin, Bohol, Anda)", "Guías locales y guía español"], notIncluded: [...defaultNotIncluded, "Visado"], itinerary: [], tags: ["verano"] },
  ...
  { id: "filipinas-verano-2026-08-17", destinationId: "filipinas-verano", title: "Filipinas Verano — Agosto 2026 (2)", departureDate: "2026-08-17", returnDate: "2026-08-29", durationDays: 13, priceFrom: 1350, flightEstimate: 750, totalPlaces: 15, placesLeft: 15, coordinatorId: "marta", status: "open", included: [...defaultIncluded, "Vuelos internos y ferry", "Island Hopping tours con comida", "Tours de un día (Camiguin, Bohol, Anda)", "Guías locales y guía español"], notIncluded: [...defaultNotIncluded, "Visado"], itinerary: [], tags: ["verano"] },
  // Filipinas Invierno
